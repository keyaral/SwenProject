...
public class Logic {
	...
	private void setupBaseEvents() {
		...
		System.out.println(	processform( new String[] {"0","4128","Wellington", "Rotarua","8","10","200","200","1","Tuesday", "5", "3","KpStart"} ));	
		System.out.println(	processform( new String[] {"0","4129","Auckland", "Rotarua","8","10","200","200","1","Tuesday", "5", "3","KpStart"} ));	
		System.out.println(	processform( new String[] {"0","4120","Rotarua", "Auckland","8","10","200","200","1","Tuesday", "5", "3","KpStart"} ));	
		System.out.println(	processform( new String[] {"0","4125","Wellington", "Auckland","8","10","200","200","1","Tuesday", "5", "3","KpStart"} ));	
		System.out.println("routes done ");
		
		
		System.out.println(	processform( new String[] {"5","5126","Rotarua", "Auckland","8","10","1", "10-17-2014"} ) );	
		System.out.println(	processform( new String[] {"5","5126","Rotarua", "Auckland","8","10","2", "10-17-2014"} ) ) ;
